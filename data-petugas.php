...
<body>
    <div class="container text-white">
        <h1 class="card-header text-center mt-2">SISTEM INFORMASI PERPUSTAKAAN (PETUGAS)
            <hr>
        </h1>
        <div class="" style="text-align: center; ; border-color:black;  position: absolute; right:20px; top:15px;">
            <a href="index.php" class="nav-link"><i class="fa fa-user-o fa-lg ">
    ...
    <div class="container-fluid">
        <div class="card" style="width:80rem; margin: 0 auto;">
            <div class="card-header" style="background-color:#116A7B;">
                <a href="add-petugas.php" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Tambah
                    Data</a>
            </div>
            ...
            <div class="card-body">
                <table class="table table-bordered table-hover align-middle text-center">
                    ...
                    <tbody>
                        <?php
                        $sql_tampil = "SELECT * FROM peminjam";
                        ...
                        while ($row = mysqli_fetch_array($query_tampil, MYSQLI_BOTH)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="ubah-petugas.php?kode=<?php echo $row['nim']; ?>" type="button"
                                        class="btn btn-success btn-sm ">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <a href="del-petugas.php?kode=<?php echo $row['nim']; ?>" type="button"
